...
Feature: Tails has a sane default configuration
  ...
  Scenario: The live user is setup correctly
    ...
    And the live user is a member of only its own group and "audio cdrom dialout floppy grsec-proc grsec-tpe video plugdev netdev scanner lp lpadmin vboxsf"
